 ...
 * @generated
 */
public class AdtSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AdtPackage.ASORT: {
				ASort aSort = (ASort)theEObject;
				T result = caseASort(aSort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AdtPackage.SUB_SORT: {
				SubSort subSort = (SubSort)theEObject;
				T result = caseSubSort(subSort);
				if (result == null) result = caseASort(subSort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AdtPackage.SORT: {
				...
				if (result == null) result = caseASort(sort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AdtPackage.TERM: {
				...
				if (result == null) result = caseATerm(term);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AdtPackage.VARIABLE: {
				...
				if (result == null) result = caseATerm(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ASort</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>ASort</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseASort(ASort object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sub Sort</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sub Sort</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSubSort(SubSort object) {
		return null;
	}
