 ...
 * <ul>
 *   <li>{@link ch.unige.cui.smv.metamodel.ts.All#getS <em>S</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.unige.cui.smv.metamodel.ts.TsPackage#getAll()
 * @model
 * @generated
 */
public interface All extends NonVariableStrategy {
	/**
	 ...
	 * @see #setS(Strategy)
	 * @see ch.unige.cui.smv.metamodel.ts.TsPackage#getAll_S()
	...
	/**
	 * Sets the value of the '{@link ch.unige.cui.smv.metamodel.ts.All#getS <em>S</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
