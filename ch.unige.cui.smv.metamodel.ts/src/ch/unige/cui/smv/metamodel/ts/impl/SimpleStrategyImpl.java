 ...
 * <ul>
 * <li>
 * {@link ch.unige.cui.smv.metamodel.ts.impl.SimpleStrategyImpl#getEquations
 * <em>Equations</em>}</li>
 * </ul>
 * </p>
 * 
...
public class SimpleStrategyImpl extends NonVariableStrategyImpl implements
		SimpleStrategy {
	/**
	 * The cached value of the '{@link #getEquations() <em>Equations</em>}'
	...
	public EList<Equation> getEquations() {
		if (equations == null) {
			equations = new EObjectContainmentEList<Equation>(Equation.class,
					this, TsPackage.SIMPLE_STRATEGY__EQUATIONS);
		}
		return equations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TsPackage.SIMPLE_STRATEGY__EQUATIONS:
			return ((InternalEList<?>) getEquations()).basicRemove(otherEnd,
					msgs);
		}
