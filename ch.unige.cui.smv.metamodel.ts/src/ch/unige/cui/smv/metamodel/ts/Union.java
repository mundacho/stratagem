 ...
 * <ul>
 *   <li>{@link ch.unige.cui.smv.metamodel.ts.Union#getS1 <em>S1</em>}</li>
 *   <li>{@link ch.unige.cui.smv.metamodel.ts.Union#getS2 <em>S2</em>}</li>
 * </ul>
 * </p>
 *
 * @see ch.unige.cui.smv.metamodel.ts.TsPackage#getUnion()
 * @model
 * @generated
 */
public interface Union extends NonVariableStrategy {
	/**
	 ...
	 * @see #setS1(Strategy)
	 * @see ch.unige.cui.smv.metamodel.ts.TsPackage#getUnion_S1()
	...
	/**
	 * Sets the value of the '{@link ch.unige.cui.smv.metamodel.ts.Union#getS1 <em>S1</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setS2(Strategy)
	 * @see ch.unige.cui.smv.metamodel.ts.TsPackage#getUnion_S2()
	 * @model containment="true" required="true"
	 * @generated
	 */
	Strategy getS2();
	...
	/**
	 * Sets the value of the '{@link ch.unige.cui.smv.metamodel.ts.Union#getS2 <em>S2</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
