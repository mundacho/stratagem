...
unmanagedSourceDirectories in Compile := (baseDirectory.value / "src")::(baseDirectory.value / "src-gen")::(baseDirectory.value / "xtend-gen")::Nil

unmanagedResourceDirectories in Compile :=  (baseDirectory.value / "src-gen")::(baseDirectory.value / "xtend-gen")::Nil
